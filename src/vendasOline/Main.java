...
public class Main{
    public static void main(String[] args) {
        ...
        try {
            ...
            ProdutoControle produtoControle = new ProdutoControle(conn);
                ...
                switch (opcao) {
                    case 1: 
                        try {
                            ...
                            controller.inserirCliente(new Cliente(0, nome, email, telefone, endereco)); 
                        } catch (Exception e) {
                    ...
                    case 4:
                        ...
                        break;
                    case 0: 
                        System.out.println(SplashScreen.getSplashScreen(controller.getConnection())); 
                        return;
                    default:
                        System.out.println("Opção inválida!");
                }
            ...
            switch (opcao) {
                ...
                case 2: 
                    try {
                        ...
                        int id = scanner.nextInt();
                        scanner.nextLine(); 
                        Produto produtoAtualizar = controller.listarProdutoPorId(id);
